...
class Rocket_ui(object):
    ...
    def open_victory(self):
        self.stop_audio()
        self.victory_window = v.Victoire(self.adversaire, self.pokedex_sauvages, self.inventaire_joueur, self.pokemon_utilise, self.pokedex, True)
    ...
    def open_loose(self):
        ...
        self.Pokedex.setEnabled(False)
        self.Fuite.setEnabled(False)
        self.victory_window = d.Defaite(self.adversaire, self.pokedex_sauvages, self.inventaire_joueur, self.pokemon_utilise, self.pokedex, True)
        self.victory_window.show()

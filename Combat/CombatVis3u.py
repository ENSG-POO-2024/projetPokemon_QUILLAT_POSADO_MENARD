...
class Combat_ui(object):
    ...
    def open_pokedex(self): 
        ...
        self.pokedex_window = ch.ChoixPokemonWindow(self.adversaire, self.inventaire_joueur, self.pokedex_sauvages, True)  
    ...
    def affichage_attaque(self, chemin_image, attaquant, defenseur, degats, speciale):
        ...
        self.text_label.setGeometry(x, y, largeur, hauteur)  # Remplacez x, y, largeur et hauteur par les coordonnées et dimensions souhaitées
...
if __name__ == "__main__":
    ...
    poke_sauvage = poke.Pokemon("Electhor",15,12,90,90,85,125,90,poke.Electrik(),False)
